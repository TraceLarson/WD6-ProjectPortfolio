...
class __TwigTemplate_fe8b9454d66be5d658c51feabb46177a861034150283c06a0272096a8189a82a extends Twig_Template
{
    ...
    <article>
        <section class=\"container\">
            <h2>Input Student's name and final grade percentage (%)</h2>
            <form class=\"form\">
                <div class=\"form-group\">
                    <label class=\"d-none\" for=\"name\">Student Name</label>
                    <input class=\"form-control\" type=\"text\" name=\"name\" id=\"name\">
                </div>
                <div class=\"form-group\">
                    <label class=\"d-none\" for=\"grade\">Grade Percentage</label>
...
{% endblock %}
", "default/index.html.twig", "/Users/tracelarson/Remote/Wd6-ProjectPortfolio/Solo Work/lamp-practical/templates/default/index.html.twig");
    }
}
